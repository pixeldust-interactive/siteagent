...
= 0.3.8 =
* Left native Technical details keyboard and pointer events entirely untouched for Jira SA-6.
* Limited delegated Enter and Space handling to exact starter buttons and kept composer submission isolated.
* Added a dedicated visible keyboard-focus indicator and regression coverage for the interaction boundary.
...
* Moved canonical action arguments behind a collapsed Technical details disclosure.
* Added action-specific confirmation labels, review-only guidance, cancellation and rollback wording, and readable completion summaries.
* Added proposal accessibility, disclosure, and responsive-containment regression coverage.
